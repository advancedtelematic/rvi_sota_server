define(function(require) {
  ...
  var React = require('react'),
      DevicesPageComponent = require('components/devices/devices-page-component'),
      ...
      DevicePageComponent = require('components/devices/device-page-component'),
            ...
            <div className="navbar-collapse collapse">
                <ul className="nav side-nav">
                  <li role="presentation">
                    <Link to="devices" className="devices"><i className="fa fa-car nav-link-btn"/>Devices</Link>
                  </li>
                  <li role="presentation">
